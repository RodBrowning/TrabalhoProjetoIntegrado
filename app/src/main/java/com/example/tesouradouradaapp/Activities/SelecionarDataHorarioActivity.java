...
import com.example.tesouradouradaapp.Adapters.SelecionarDataHorarioAdapter;
...
public class SelecionarDataHorarioActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTituloParaActivity(intentEditar, VizualizarAgendamentoActivity.EDITAR);
        calendar = setDataParaIniciarCalendario(Calendar.getInstance(), intentEditar, VizualizarAgendamentoActivity.ID_AGEDAMENTO_EDITAR, agendaViewModel);
    ...
    private void carregarCodigosIguaisParaOnCreateEOnDateSet() {
        ...
        try {
            ...
            if (intentEditar.hasExtra(VizualizarAgendamentoActivity.EDITAR)) {
                horariosAgendadosParaDia = getHorariosAgendadosPadaDia(horarioAbertura, horarioFechamento, true, intentEditar.getIntExtra(VizualizarAgendamentoActivity.ID_AGEDAMENTO_EDITAR, 0));
            } else {
                horariosAgendadosParaDia = getHorariosAgendadosPadaDia(horarioAbertura, horarioFechamento, false, intentEditar.getIntExtra(VizualizarAgendamentoActivity.ID_AGEDAMENTO_EDITAR, 0));
            }
